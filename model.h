...
Shape* model[] = {
	//new Rect(Vector(1, 81.6, 170), Vector(0, 0, -170), Vector(0, -81.6, 0), Texture(nullptr, Vector(), Vector(1, 1, 1) * .999, SPEC)),
	...
	//new Sphere(1e5, Vector(-1e5 + 99, 40.8, 81.6), Texture(nullptr, Vector(), Vector(1, 1, 1) * .999, SPEC)),
	...
	//new Rect(Vector(1, 81.6, 0), Vector(98, 0, 0), Vector(0, -81.6, 0), Texture(nullptr, Vector(), Vector(.75, .75, .25), DIFF)),
	...
	new bezierSpin(Vector(73, 0, 88), curve, Texture("vase2.jpg", Vector(), Vector(1, 1, 1) * .999, DIFF)),
